  ...
  /* ===================== Day 1 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "用田字格带孩子描红『春』，重点讲『日』字底要写扁、托住上面。"
      },
      {
        type: "chuantong",
        title: "二十四节气 · 立春",
  ...
  /* ===================== Day 2 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "对比『乌』（乌鸦）：『鸟』有一点（眼睛），『乌』没有点（黑得看不见眼睛），是孩子最爱记的对比。"
      },
      {
        type: "shenhua",
        title: "神话 · 精卫填海",
  ...
  /* ===================== Day 3 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "在纸上画『水』的古字（像流动的曲线），再写楷体，帮孩子建立『字—形—义』联系。"
      },
      {
        type: "meiwen",
        title: "名家美文 · 河里的白鹅",
  ...
  /* ===================== Day 4 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "讲『福倒贴=福到了』的谐音梗，让孩子自己把『福』字倒过来贴，记住这个字一生难忘。"
      },
      {
        type: "chengyu",
        title: "张灯结彩",
  ...
  /* ===================== Day 5 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "对比『兔』和『免』：一个点之差，正是小尾巴，孩子用这个细节就不会写错。"
      },
      {
        type: "shenhua",
        title: "仓颉造字",
  ...
  /* ===================== Day 6 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "用几粒真米摆在桌上，对照『米』字的点，孩子一下就记住了上下那几颗『米粒』。"
      },
      {
        type: "chuantong",
        title: "二十四节气 · 芒种与丰收",
  ...
  /* ===================== Day 7 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "画一弯月牙对照『月』字，告诉孩子：古人就是照着月亮的样子造出这个字的。"
      },
      {
        type: "chengyu",
        title: "花好月圆",
    ...
    items: [
      {
        ...
        tip: "对比教学：『氵』是站着的水，『灬』是躺着的火。找一找家里哪些字带这两类偏旁（洗、煮）。"
      },
      {
        type: "tongyao",
        title: "火苗谣",
  ...
  /* ===================== Day 9 ===================== */
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: "指着自己的头和心说：『思=用脑想、用心念』，孩子立马懂这个字为什么带『心』底。"
      },
      {
        type: "chuantong",
        title: "传统节日 · 重阳节",
